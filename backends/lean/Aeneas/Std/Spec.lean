...
structure SpecInfo where
  ...
  /-- Additional proposition premises generated by `mk_spec_mono`, before the
  final postcondition-comparison premise. -/
  mk_spec_mono_preconditions : Nat := 0
  mk_spec_bind : Name
  mk_spec_bind_skip_args : Nat
  /-- Additional proposition premises generated by `mk_spec_bind`, before the
  final continuation premise. -/
  mk_spec_bind_preconditions : Nat := 0
